      ...
      <div class="product-list">
         <div class="px-3 py-3 pr-3 mx-auto float-left">
            <button type="button" class="btn btn-primary">
               <router-link to="/admin/dashboard" class="button-add">
                  <i class="fa-solid fa-circle-left"></i>
                  Quay lại
               </router-link>
            </button>
         </div>
         <form class="px-3 py-3 pr-3 mx-auto float-left form-inline my-2 my-lg-0">
   ...
   computed: {
      ...
      filteredUsers() {
         ...
         return this.users.filter((_user, index) =>
            this.userStrings[index].toLocaleLowerCase().includes(this.searchText.toLocaleLowerCase())
         );
      },
      filteredUsersCount() {
